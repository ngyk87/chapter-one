...
By default, the test for column 1 is skipped. To enable the test, you will have to comment or remove the line `@pytest.mark.skip`. Subsequently, you can proceed to define the test by using the `assert` statement.
...
In this walkthrough we shall use an example CSV file that can be downloaded from: https://github.com/DataKind-SG/test-driven-data-cleaning/raw/master/input/foobar_data.csv
